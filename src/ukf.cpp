...
UKF::UKF()
    ...
    : use_laser_{true}  // if this is false, radar measurements will be ignored (except during init)
      ,
      use_radar_{true}  // Process noise standard deviation longitudinal acceleration in m/s^2
      ,
      std_a_{5.0}
...
void UKF::ProcessMeasurement(const MeasurementPackage& meas_package) {
    ...
    double dt = 1e-6 * static_cast<double>(meas_package.timestamp_ - previous_timestamp_);
