...
struct lmarker
{
	...
	explicit lmarker(double setX, double setY)
		: x(setX)
        , y(setY)
	{}
...
struct rmarker
{
	...
	explicit rmarker(double setRho, double setPhi, double setRhoDot)
		: rho(setRho)
        , phi(setPhi)
        , rho_dot(setRhoDot)
	{}
...
public:
    ...
    */
    ...
    static lmarker lidarSense(
        Car& car,
        pcl::visualization::PCLVisualizer::Ptr& viewer,
        long long timestamp,
        bool visualize);

    static rmarker radarSense(
        Car& car,
        const Car& ego,
        pcl::visualization::PCLVisualizer::Ptr& viewer,
        long long timestamp,
